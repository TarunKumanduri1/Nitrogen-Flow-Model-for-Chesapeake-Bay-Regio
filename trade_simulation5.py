...
folder_name_output = 'trade_simulation5'
folder_name_plots = 'trade-simulation5'
# Import data
## Planting area
...
dat['reduction_factor'] = np.where(dat['is_chesapeake'], 0.4, 1)
...
dat2['domestic_animal_nitrogen'] = dat2['domestic_animal_nitrogen']
##############################################################################
